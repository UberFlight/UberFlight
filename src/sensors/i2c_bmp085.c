...
//    gpioExtiLineConfig(EXTI_PortSourceGPIOC, GPIO_PinSource14);
...
{
    convDone = false;
    i2cWrite(BMP085_I2C, BMP085_I2C_ADDR, BMP085_CTRL_MEAS_REG, BMP085_T_MEASURE);
}
...
static void bmp085_get_ut(void)
{
    ...
    i2cRead(BMP085_I2C, BMP085_I2C_ADDR, BMP085_ADC_OUT_MSB_REG, 2, data);
...
static void bmp085_start_up(void)
{
    ...
    convDone = false;
    i2cWrite(BMP085_I2C, BMP085_I2C_ADDR, BMP085_CTRL_MEAS_REG, ctrl_reg_data);
}
...
static void bmp085_get_up(void)
{
    ...
    i2cRead(BMP085_I2C, BMP085_I2C_ADDR, BMP085_ADC_OUT_MSB_REG, 3, data);
...
{
    uint8_t data[22];
    i2cRead(BMP085_I2C, BMP085_I2C_ADDR, BMP085_PROM_START__ADDR, BMP085_PROM_DATA__LEN, data);
