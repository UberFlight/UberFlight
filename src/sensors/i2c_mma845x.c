...
bool mma8452Detect(sensor_t *acc)
{
    ...
    ack = i2cRead(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_WHO_AM_I, 1, &sig);
...
static void mma8452Init(sensor_align_e align)
{
    ...
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG1, 0); // Put device in standby to configure stuff
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_XYZ_DATA_CFG, MMA8452_FS_RANGE_8G);
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_HP_FILTER_CUTOFF, MMA8452_HPF_CUTOFF_LV4);
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG2, MMA8452_CTRL_REG2_MODS_HR | MMA8452_CTRL_REG2_MODS_HR << 3); // High resolution measurement in both sleep and active modes
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG3, MMA8452_CTRL_REG3_IPOL); // Interrupt polarity (active HIGH)
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG4, MMA8452_CTRL_REG4_INT_EN_DRDY); // Enable DRDY interrupt (unused by this driver)
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG5, 0); // DRDY routed to INT2
    i2cWrite(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_CTRL_REG1, MMA8452_CTRL_REG1_LNOISE | MMA8452_CTRL_REG1_ACTIVE); // Turn on measurements, low noise at max scale mode, Data Rate 800Hz. LNoise mode makes range +-4G.
...
static bool mma8452Read(int16_t *accelData)
{
    ...
    i2cRead(MMA8845x_I2C, MMA8452_ADDRESS, MMA8452_OUT_X_MSB, 6, buf);
