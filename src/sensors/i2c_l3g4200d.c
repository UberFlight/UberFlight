...
static bool l3g4200dRead(int16_t *gyroData);
...
bool l3g4200dDetect(sensor_t *gyro, uint16_t lpf)
{
    ...
    i2cRead(L3G4200D_I2C, L3G4200D_ADDRESS, L3G4200D_WHO_AM_I, 1, &deviceid);
...
static void l3g4200dInit(sensor_align_e align)
{
    ...
    ack = i2cWrite(L3G4200D_I2C, L3G4200D_ADDRESS, L3G4200D_CTRL_REG4, L3G4200D_FS_SEL_2000DPS);
    if (!ack)
        failureMode(3);

    delay(5);
    i2cWrite(L3G4200D_I2C, L3G4200D_ADDRESS, L3G4200D_CTRL_REG1, L3G4200D_POWER_ON | mpuLowPassFilter);
    if (align > 0)
        gyroAlign = align;
}
...
static bool l3g4200dRead(int16_t *gyroData)
{
    ...
    i2cRead(L3G4200D_I2C, L3G4200D_ADDRESS, L3G4200D_AUTOINCR | L3G4200D_GYRO_OUT, 6, buf);
