...
static bool mpu3050Read(int16_t *gyroData);
...
bool mpu3050Detect(sensor_t *gyro, uint16_t lpf)
{
    ...
    ack = i2cWrite(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_SMPLRT_DIV, 0);
    if (!ack)
        return false;
...
static void mpu3050Init(sensor_align_e align)
{
    ...
    i2cWrite(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_DLPF_FS_SYNC, MPU3050_FS_SEL_2000DPS | mpuLowPassFilter);
    i2cWrite(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_INT_CFG, 0);
    i2cWrite(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_USER_CTRL, MPU3050_USER_RESET);
    i2cWrite(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_PWR_MGM, MPU3050_CLK_SEL_PLL_GX);
...
static bool mpu3050Read(int16_t *gyroData)
{
    ...
    i2cRead(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_GYRO_OUT, 6, buf);
...
{
    uint8_t buf[2];
    i2cRead(MPU3050_I2C, MPU3050_ADDRESS, MPU3050_TEMP_OUT, 2, buf);
